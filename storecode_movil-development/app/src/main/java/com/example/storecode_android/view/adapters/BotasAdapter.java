...
public class BotasAdapter extends RecyclerView.Adapter<HolderModeloInstaladas> implements Filterable {

    private static final Logger log = LogFile.getLogger(BotasAdapter.class);
    /*private final Activity context;
    private final List<RespObtenerDatosAplicaciones> modeloList;
    private List<RespObtenerDatosAplicaciones> mFilteredList;*/

    private final ArrayList<ProductoBotas> modeloList = new ArrayList<ProductoBotas>();
    private int aux;
    ...
    private List<ProductoBotas> mFilteredList = modeloList;
    ...
    public BotasAdapter(Activity context, SearchView searchView) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<ProductoBotas> filteredList = new ArrayList<>();
                    for (ProductoBotas modelo : modeloList) {
            ...
            protected void publishResults(CharSequence charSequence,
                ...
                mFilteredList = (ArrayList<ProductoBotas>) filterResults.values;
    ...
    public void onBindViewHolder(@NonNull HolderModeloInstaladas holder, int position) {
        ProductoBotas producto = mFilteredList.get(position);
        System.out.println("----------------");
    ...
    public void updateData(List<ProductoBotas> data) {
