...
public class ProductoCasual implements Serializable {
    ...
    * */
    ...
    public ProductoCasual(){

    }

    public ProductoCasual(Integer idProducto, String nombreProducto, String desProducto, double precioUnitarioProducto, String imagenProducto, double stockRealProducto, String statusProducto, Integer idMarca, Integer idCategoria, Integer idUsuario) {
