...
public class ProductoSandalias implements Serializable {
    ...
    * */
    ...
    public ProductoSandalias(){

    }

    public ProductoSandalias(Integer idProducto, String nombreProducto, String desProducto, double precioUnitarioProducto, String imagenProducto, double stockRealProducto, String statusProducto, Integer idMarca, Integer idCategoria, Integer idUsuario) {
