...
public class ProductoBotas implements Serializable {
    ...
    * */
    ...
    public ProductoBotas(){

    }

    public ProductoBotas(Integer idProducto, String nombreProducto, String desProducto, double precioUnitarioProducto, String imagenProducto, double stockRealProducto, String statusProducto, Integer idMarca, Integer idCategoria, Integer idUsuario) {
