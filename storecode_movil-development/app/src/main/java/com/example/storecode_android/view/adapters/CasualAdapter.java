...
public class CasualAdapter extends RecyclerView.Adapter<HolderModeloInstaladas> implements Filterable {

    private static final Logger log = LogFile.getLogger(CasualAdapter.class);
    /*private final Activity context;
    private final List<RespObtenerDatosAplicaciones> modeloList;
    private List<RespObtenerDatosAplicaciones> mFilteredList;*/

    private final ArrayList<ProductoCasual> modeloList = new ArrayList<ProductoCasual>();
    private int aux;
    ...
    private List<ProductoCasual> mFilteredList = modeloList;
    ...
    public CasualAdapter(Activity context, SearchView searchView) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<ProductoCasual> filteredList = new ArrayList<>();
                    for (ProductoCasual modelo : modeloList) {
            ...
            protected void publishResults(CharSequence charSequence,
                ...
                mFilteredList = (ArrayList<ProductoCasual>) filterResults.values;
    ...
    public void onBindViewHolder(@NonNull HolderModeloInstaladas holder, int position) {
        ProductoCasual producto = mFilteredList.get(position);
        System.out.println("----------------");
    ...
    public void updateData(List<ProductoCasual> data) {
