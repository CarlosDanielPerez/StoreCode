...
public class TenisAdapter extends RecyclerView.Adapter<HolderModeloInstaladas> implements Filterable {

        private static final Logger log = LogFile.getLogger(TenisAdapter.class);
    /*private final Activity context;
    private final List<RespObtenerDatosAplicaciones> modeloList;
    private List<RespObtenerDatosAplicaciones> mFilteredList;*/

    private final ArrayList<ProductoTenis> modeloList= new ArrayList<ProductoTenis>();
    private int aux;
    ...
    private List<ProductoTenis> mFilteredList= modeloList;
    ...
    public TenisAdapter( Activity context, SearchView searchView) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<ProductoTenis> filteredList = new ArrayList<>();
                    for (ProductoTenis modelo : modeloList) {
            ...
            protected void publishResults(CharSequence charSequence,
                ...
                mFilteredList = (ArrayList<ProductoTenis>) filterResults.values;
    ...
    public void onBindViewHolder(@NonNull HolderModeloInstaladas holder, int position) {
        ProductoTenis producto= mFilteredList.get(position);
        System.out.println("----------------");
    ...
    public void updateData(List<ProductoTenis> data){
