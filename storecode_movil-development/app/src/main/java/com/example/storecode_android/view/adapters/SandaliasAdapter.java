...
public class SandaliasAdapter extends RecyclerView.Adapter<HolderModeloInstaladas> implements Filterable {

    private static final Logger log = LogFile.getLogger(SandaliasAdapter.class);
    /*private final Activity context;
    private final List<RespObtenerDatosAplicaciones> modeloList;
    private List<RespObtenerDatosAplicaciones> mFilteredList;*/

    private final ArrayList<ProductoSandalias> modeloList = new ArrayList<ProductoSandalias>();
    private int aux;
    ...
    private List<ProductoSandalias> mFilteredList = modeloList;
    ...
    public SandaliasAdapter(Activity context, SearchView searchView) {
        ...
        return new Filter() {
            ...
            protected FilterResults performFiltering(CharSequence charSequence) {
                ...
                if (charString.isEmpty()) {
                    ...
                    ArrayList<ProductoSandalias> filteredList = new ArrayList<>();
                    for (ProductoSandalias modelo : modeloList) {
            ...
            protected void publishResults(CharSequence charSequence,
                ...
                mFilteredList = (ArrayList<ProductoSandalias>) filterResults.values;
    ...
    public void onBindViewHolder(@NonNull HolderModeloInstaladas holder, int position) {
        ProductoSandalias producto = mFilteredList.get(position);
        System.out.println("----------------");
    ...
    public void updateData(List<ProductoSandalias> data) {
