...
public class ProductoTenis implements Serializable {
    ...
    * */
    ...
    public ProductoTenis(){

    }

    public ProductoTenis(Integer idProducto, String nombreProducto, String desProducto, double precioUnitarioProducto, String imagenProducto, double stockRealProducto, String statusProducto, Integer idMarca, Integer idCategoria, Integer idUsuario) {
